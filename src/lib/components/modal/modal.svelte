<script>
  ...
  import {pArea, pFencedTiles, pIDs, pyodideRan, boardOccupiedTiles, country, playerID, pResultString} from '$lib/store/pentominos.js';
  ...
  function pressedSubmit()
  {
    ...
    postResults($pIDs, $pArea, $playerID, $country, $pResultString);
    closeModal();
